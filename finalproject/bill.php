...
@media only screen and (max-width: 70px){
  ...
  let x = document.forms["bill"]["contact"].value;
  if (x == "" || x==null) {
    alert("mobile number must be entered");
    return false;
  }
  let y = document.forms["bill"]["emailid"].value;
  if (y == "" || y==null) {
    alert("email id must be entered");
    return false;
  }
  let z = document.forms["bill"]["carddetail"].value;
  if (z == "" || z==null) {
    alert("card details must be entered");
    return false;
  }
  let a= document.forms["bill"]["expmonth"].value;
  if (a == "" || a==null) {
    alert("enter expiry month");
    return false;
  }
  let b = document.forms["bill"]["cvv"].value;
  if (b == "" || b==null) {
        ...
        <header>
            <div class="container">
                <div class="left">
                    ...
                    <form action="" method="POST" name="bill">
                        Full name
               ...
               <div class="right">
                    <h3>Payment Information</h3>
						...
						<label>
                        Card Details<br>
                        <input type="text" name="carddetail" placeholder="Enter Card number">
						</label><br>
                        <label>
						Exp Month<br>
