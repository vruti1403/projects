...
<html>
 ...
 <script>
  ...
  let x = document.forms["ticket"]["Name"].value;
  if (x == "" || x==null) {
    alert("Name must be entered");
    return false;
  }
  let y = document.forms["ticket"]["npass"].value;
  if (y == "" || y==null) {
    alert("Number of passes must be entered");
    return false;
  }
  let z = document.forms["ticket"]["phno"].value;
  if (z == "" || z==null) {
...
<a href="logout.php"><button type="submit" class="regbtn">LOGOUT</button></a></div>
 <form action="" method="POST" class="container" name="ticket" onsubmit="return validateticket()>
    ...
    <input type="number" name="npass" ><br>
		
	<label><b>CONTACT NO</b></label>
    <input type="text" placeholder="Enter Phone No" name="phno" ><br>
