...
<script>
       function validatestall() {
      let w = document.forms["stallbook"]["owner_name"].value;
  if (w == "" || w==null) {
    alert("Name of owner must be entered");
    return false;
  }
  let x = document.forms["stallbook"]["email_id"].value;
  if (x == "" || x==null) {
    alert("Email id must be entered");
    return false;
  }
  let y = document.forms["stallbook"]["mobile_no"].value;
  if (y == "" || y==null) {
    alert("Mobile number must be entered");
    return false;
  }
  let z = document.forms["stallbook"]["city"].value;
  if (z == "" || z==null) {
    alert("city must be entered");
    return false;
  }
  let a= document.forms["stallbook"]["brand_name"].value;
  if (a == "" || a==null) {
    alert("Brand name must be entered");
    return false;
  }
  let b = document.forms["stallbook"]["product_category"].value;
  if (b == "" || b==null) {
...
<div class="container1">
			...
			<div class="content">
				<form name="stallbook" action="" method="POST" onsubmit="return validatestall()">
