...
<head>
    ...
    function validateForm() {
      let w = document.forms["#exampleModal"]["full_name"].value;
  if (w == "" || w==null) {
    alert("Name must be filled out");
    return false;
  }
  let x = document.forms["#exampleModal"]["username"].value;
  if (x == "" || x==null) {
    alert("User Name must be filled out");
    return false;
  }
  let y = document.forms["#exampleModal"]["password"].value;
  if (y == "" || y==null) {
...
<script>
  function validate() {
  let a= document.forms["updatemodal"]["full_name"].value;
  if (a == "" || a==null) {
    alert("Name must be filled out");
    return false;
  }
  let b = document.forms["updatemodal"]["username"].value;
  if (b == "" || b==null) {
    alert("User Name must be filled out");
    return false;
  }
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form  name="addadmin" action="add-admin2.php" onsubmit="return validateForm()" method="POST">
...
<div class="modal fade" id="updatemodal" tabindex="-1" aria-labelledby="updatemodal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form name="updatemodal"action="update-admin2.php" onsubmit="return validate()" method="POST">
      <div class="modal-body">  
