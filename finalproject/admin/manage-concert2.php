...
<head>
    ...
    <script>
      ...
      let w = document.forms["exampleModal"]["c_date"].value;
  if (w == "" || w==null) {
    alert("Concert date must be entered");
    return false;
  }
  let x = document.forms["exampleModal"]["c_venue"].value;
  if (x == "" || x==null) {
    alert("Concert venue must be entered");
    return false;
  }
  let y = document.forms["exampleModal"]["venue_capacity"].value;
  if (y == "" || y==null) {
    alert("Venue capacity must be entered");
    return false;
  }
  let z = document.forms["exampleModal"]["c_artist"].value;
  if (z == "" || z==null) {
    alert("Concert artist must be entered");
    return false;
  }
}
      </script>
      <script>
       function validateupdateconcert() {
      let w = document.forms["updatemodal"]["c_date"].value;
  if (w == "" || w==null) {
    alert("Concert date must be entered");
    return false;
  }
  let x = document.forms["updatemodal"]["c_venue"].value;
  if (x == "" || x==null) {
    alert("Concert venue must be entered");
    return false;
  }
  let y = document.forms["updatemodal"]["venue_capacity"].value;
  if (y == "" || y==null) {
    alert("Venue capacity must be entered");
    return false;
  }
  let z = document.forms["updatemodal"]["c_artist"].value;
  if (z == "" || z==null) {
    alert("Concert artist must be entered");
    return false;
  }
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form name="exampleModal" action="add-concert2.php" onsubmit="return validateconcert()" method="POST">
...
<div class="modal fade" id="updatemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="update-concert2.php" name="updatemodal" onsubmit="return validateupdateconcert()" method="POST">
      <div class="modal-body">
