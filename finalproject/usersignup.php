...
<script>
  ...
  let x = document.forms["usersignup"]["username"].value;
  if (x == "" || x==null) {
    alert("Name must be filled out");
    return false;
  }
  let y = document.forms["usersignup"]["password"].value;
  if (y == "" || y==null) {
...
<div id="form">
<form method="POST" name="usersignup" action="" onsubmit="return validateForm()">
